...
public class GlobalExceptionHandler {
    ...
    // handleDuplicateUserException(project.project.Exception.DuplicateUserException
    // ex) {
    ...
    // public ResponseEntity<ApiResponse<Void>>
    // handleDataIntegrityViolation(org.springframework.dao.DataIntegrityViolationException
    // ex) {
    // return ResponseEntity.status(HttpStatus.CONFLICT)
